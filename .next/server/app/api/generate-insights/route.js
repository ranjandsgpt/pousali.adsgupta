(()=>{var e={};e.id=131,e.ids=[131],e.modules={20399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{"use strict";e.exports=require("assert")},78893:e=>{"use strict";e.exports=require("buffer")},61282:e=>{"use strict";e.exports=require("child_process")},84770:e=>{"use strict";e.exports=require("crypto")},17702:e=>{"use strict";e.exports=require("events")},92048:e=>{"use strict";e.exports=require("fs")},20629:e=>{"use strict";e.exports=require("fs/promises")},32615:e=>{"use strict";e.exports=require("http")},35240:e=>{"use strict";e.exports=require("https")},98216:e=>{"use strict";e.exports=require("net")},19801:e=>{"use strict";e.exports=require("os")},55315:e=>{"use strict";e.exports=require("path")},35816:e=>{"use strict";e.exports=require("process")},86624:e=>{"use strict";e.exports=require("querystring")},76162:e=>{"use strict";e.exports=require("stream")},82452:e=>{"use strict";e.exports=require("tls")},74175:e=>{"use strict";e.exports=require("tty")},17360:e=>{"use strict";e.exports=require("url")},21764:e=>{"use strict";e.exports=require("util")},6162:e=>{"use strict";e.exports=require("worker_threads")},71568:e=>{"use strict";e.exports=require("zlib")},72254:e=>{"use strict";e.exports=require("node:buffer")},87561:e=>{"use strict";e.exports=require("node:fs")},88849:e=>{"use strict";e.exports=require("node:http")},22286:e=>{"use strict";e.exports=require("node:https")},87503:e=>{"use strict";e.exports=require("node:net")},49411:e=>{"use strict";e.exports=require("node:path")},97742:e=>{"use strict";e.exports=require("node:process")},84492:e=>{"use strict";e.exports=require("node:stream")},76402:e=>{"use strict";e.exports=require("node:stream/promises")},72477:e=>{"use strict";e.exports=require("node:stream/web")},41041:e=>{"use strict";e.exports=require("node:url")},47261:e=>{"use strict";e.exports=require("node:util")},65628:e=>{"use strict";e.exports=require("node:zlib")},58359:()=>{},93739:()=>{},96754:(e,t,s)=>{"use strict";s.r(t),s.d(t,{originalPathname:()=>b,patchFetch:()=>f,requestAsyncStorage:()=>h,routeModule:()=>m,serverHooks:()=>y,staticGenerationAsyncStorage:()=>g});var r={};s.r(r),s.d(r,{POST:()=>p});var n=s(49303),a=s(88716),i=s(60670),o=s(87070),u=s(58954),l=s(88293);let c="AI analysis temporarily unavailable. Please rerun analysis.",d=process.env.GEMINI_MODEL||"gemini-2.5-flash";async function p(e){let t;let s=process.env.GEMINI_API_KEY;if(!s)return o.NextResponse.json({error:"GEMINI_API_KEY is not configured",report:c},{status:503});try{t=await e.json()}catch{return o.NextResponse.json({error:"Invalid JSON body",report:c},{status:400})}let r=JSON.stringify(t,null,2),n=l.Qu+r;try{let e=new u.fA({apiKey:s}),t=await e.models.generateContent({model:d,config:{systemInstruction:l.Bp},contents:[{role:"user",parts:[{text:n}]}]}),r=t.candidates?.[0]?.content?.parts?.map(e=>e.text??"").join("\n").trim()||"";if(!r)return o.NextResponse.json({report:c},{status:200});let a=function(e){let t=e.indexOf("{");if(-1===t)return null;let s=0,r=-1;for(let n=t;n<e.length;n++){let t=e[n];if("{"===t&&s++,"}"===t&&0==--s){r=n;break}}if(-1===r)return null;let n=e.slice(t,r+1);try{return JSON.parse(n)}catch{return null}}(r);if(!a||"object"!=typeof a)return o.NextResponse.json({report:r},{status:200});return o.NextResponse.json({report:JSON.stringify(a,null,2),presentation:a},{status:200})}catch(e){return console.error("generate-insights error",e),o.NextResponse.json({report:c},{status:200})}}let m=new n.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/generate-insights/route",pathname:"/api/generate-insights",filename:"route",bundlePath:"app/api/generate-insights/route"},resolvedPagePath:"/Users/ranjan.dasgupta/pousali.adsgupta_project/pousali.adsgupta/src/app/api/generate-insights/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:h,staticGenerationAsyncStorage:g,serverHooks:y}=m,b="/api/generate-insights/route";function f(){return(0,i.patchFetch)({serverHooks:y,staticGenerationAsyncStorage:g})}},88293:(e,t,s)=>{"use strict";s.d(t,{Bp:()=>c,HK:()=>i,Qu:()=>d,SY:()=>n,di:()=>r,j5:()=>u,rx:()=>a,v:()=>o,yl:()=>l});let r=`You are an Amazon PPC data auditor. You are given:
...
{"metrics_score": number, "tables_score": number, "charts_score": number, "insights_score": number}`;function n(e,t){return`Dataset summary:
${JSON.stringify(e,null,2)}

SLM artifacts:
${JSON.stringify(t,null,2)}`}let a=`You are an Amazon PPC data analyst. You are given raw Amazon advertising and business report files (CSV or similar).
...
Return ONLY valid JSON in this exact shape (no markdown):
{
  ...
  "recovered_fields": {},
  "schema_inferences": {}
}`,i=`Analyze this normalized dataset and return structured JSON only.

Dataset:
`,o=`The attached files are Amazon PPC reports (Sponsored Products Search Term, Advertised Product, Targeting, Campaign, Business Report). Use them for metric extraction, column inference, data validation, and missing field recovery.

Optional normalized summary (for reference; prefer extracting from raw files when possible):
`,u=`You are an Amazon Seller Central and Amazon Advertising report schema expert.
