(()=>{var e={};e.id=131,e.ids=[131],e.modules={20399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{"use strict";e.exports=require("assert")},78893:e=>{"use strict";e.exports=require("buffer")},61282:e=>{"use strict";e.exports=require("child_process")},84770:e=>{"use strict";e.exports=require("crypto")},17702:e=>{"use strict";e.exports=require("events")},92048:e=>{"use strict";e.exports=require("fs")},20629:e=>{"use strict";e.exports=require("fs/promises")},32615:e=>{"use strict";e.exports=require("http")},35240:e=>{"use strict";e.exports=require("https")},98216:e=>{"use strict";e.exports=require("net")},19801:e=>{"use strict";e.exports=require("os")},55315:e=>{"use strict";e.exports=require("path")},35816:e=>{"use strict";e.exports=require("process")},86624:e=>{"use strict";e.exports=require("querystring")},76162:e=>{"use strict";e.exports=require("stream")},82452:e=>{"use strict";e.exports=require("tls")},74175:e=>{"use strict";e.exports=require("tty")},17360:e=>{"use strict";e.exports=require("url")},21764:e=>{"use strict";e.exports=require("util")},6162:e=>{"use strict";e.exports=require("worker_threads")},71568:e=>{"use strict";e.exports=require("zlib")},72254:e=>{"use strict";e.exports=require("node:buffer")},87561:e=>{"use strict";e.exports=require("node:fs")},88849:e=>{"use strict";e.exports=require("node:http")},22286:e=>{"use strict";e.exports=require("node:https")},87503:e=>{"use strict";e.exports=require("node:net")},49411:e=>{"use strict";e.exports=require("node:path")},97742:e=>{"use strict";e.exports=require("node:process")},84492:e=>{"use strict";e.exports=require("node:stream")},76402:e=>{"use strict";e.exports=require("node:stream/promises")},72477:e=>{"use strict";e.exports=require("node:stream/web")},41041:e=>{"use strict";e.exports=require("node:url")},47261:e=>{"use strict";e.exports=require("node:util")},65628:e=>{"use strict";e.exports=require("node:zlib")},58359:()=>{},93739:()=>{},2240:(e,t,r)=>{"use strict";r.r(t),r.d(t,{originalPathname:()=>S,patchFetch:()=>A,requestAsyncStorage:()=>x,routeModule:()=>v,serverHooks:()=>b,staticGenerationAsyncStorage:()=>w});var s={};r.r(s),r.d(s,{POST:()=>y});var a=r(49303),n=r(88716),i=r(60670),o=r(87070),u=r(58954),c=r(17445),l=r(9907),d=r(48907),p=r(20593),m=r(59190);let f="AI analysis temporarily unavailable. Please rerun analysis.",h=process.env.GEMINI_MODEL||"gemini-2.5-flash";async function g(e,t,r){let s=[{role:"user",parts:[{text:r}]}];(0,p.ge)(s);let a=await e.models.generateContent({model:h,config:{systemInstruction:t},contents:s});return(0,d.d)(a)}async function y(e){let t,r,s;let a=process.env.GEMINI_API_KEY;if(!a)return o.NextResponse.json({error:"GEMINI_API_KEY is not configured",report:f},{status:503});try{t=await e.json()}catch{return o.NextResponse.json({error:"Invalid JSON body",report:f},{status:400})}let n=JSON.stringify({accountSummary:t.accountSummary,campaigns:t.campaigns,searchTerms:t.searchTerms,asins:t.asins,patterns:t.patterns,sanity:t.sanity},null,2),i=`${c.Ih}

Use the following verified audit data (structured context only).

${n}`,d=(0,p.NI)(i),h="string"==typeof t.metricsReferenceContext?t.metricsReferenceContext:"",y=h?`${c.Tt}

${h}`:c.Tt,v=new u.fA({apiKey:a}),x="",w=null,b=d.length,S=Date.now();for(let e=0;e<=1;e++)try{x=await g(v,y,d);let t=Date.now()-S;if(await (0,l.g)({mode:"insight_narrative",rawResponse:x.slice(0,1e4),outcome:x?"plain_text":"empty",...e>0?{error:`retry ${e}`}:{}}),await (0,m.f)({mode:"insight_narrative",promptLength:d.length,contextSize:b,responseLatencyMs:t,validationResult:x?"ok":"empty"}),!x){r="gemini_empty",s="Gemini returned no text. Check model name and API quota.";break}let a=function(e){let t=e.trim();if(!t)return{valid:!1,narrative:null,shouldRetry:!0,reason:"empty"};if(function(e){let t=e.trim();return!!(t.includes("```")||/^\s*(import |from |def |class )/m.test(t))}(t))return{valid:!1,narrative:null,shouldRetry:!0,reason:"response_was_code"};if(function(e){let t=e.trim();return t.startsWith("{")||t.startsWith("[")}(t)){let e=function(e){let t=e.indexOf("{");if(-1===t)return null;let r=0;for(let s=t;s<e.length;s++)if("{"===e[s]&&r++,"}"===e[s]&&0==--r)try{return JSON.parse(e.slice(t,s+1))}catch{break}return null}(t);if(e&&"object"==typeof e){let t="string"==typeof e.narrative?e.narrative:"string"==typeof e.report?e.report:"string"==typeof e.text?e.text:"string"==typeof e.content?e.content:null;if(t&&t.length>50)return{valid:!0,narrative:t,shouldRetry:!1}}return t.length>200?{valid:!0,narrative:t,shouldRetry:!1,reason:"response_was_json_used_raw"}:{valid:!1,narrative:null,shouldRetry:!0,reason:"response_was_json_no_narrative_field"}}return{valid:!0,narrative:t,shouldRetry:!1}}(x);if(a.valid&&a.narrative){w=a.narrative;break}if(a.shouldRetry&&e<1)continue;if(a.narrative){w=a.narrative;break}r="validation_failed",s=a.reason??"Response format was not accepted.";break}catch(t){let e=t instanceof Error?t.message:String(t);console.error("generate-insights error",t),await (0,l.g)({mode:"insight_narrative",rawResponse:x||"(no response)",outcome:"error",error:e}),await (0,m.f)({mode:"insight_narrative",promptLength:d.length,contextSize:b,responseLatencyMs:Date.now()-S,validationResult:"error",error:e.slice(0,200)}),r="gemini_error",s=e.slice(0,200);break}let A={report:w&&w.length>0?w:f};return r&&(A.errorCode=r),s&&(A.errorDetail=s),o.NextResponse.json(A,{status:200})}let v=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/generate-insights/route",pathname:"/api/generate-insights",filename:"route",bundlePath:"app/api/generate-insights/route"},resolvedPagePath:"/Users/ranjan.dasgupta/pousali.adsgupta_project/pousali.adsgupta/src/app/api/generate-insights/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:x,staticGenerationAsyncStorage:w,serverHooks:b}=v,S="/api/generate-insights/route";function A(){return(0,i.patchFetch)({serverHooks:b,staticGenerationAsyncStorage:w})}},17445:(e,t,r)=>{"use strict";r.d(t,{Cv:()=>m,HK:()=>l,Ih:()=>i,LR:()=>o,SY:()=>a,Tt:()=>n,Y3:()=>s,gF:()=>f,j5:()=>d,ou:()=>u,rx:()=>c,yl:()=>p});let s=`You are an Amazon PPC data auditor in verification mode.
