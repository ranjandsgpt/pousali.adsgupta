...
export default function ReduceAmazonAcosPage() {
  return (
    <div className="min-h-screen pt-28 pb-20">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-[var(--color-text)] mb-6">How to Reduce Amazon ACOS</h1>
          <p className="text-lg text-[var(--color-text-muted)] max-w-2xl">
            Learn how to reduce Amazon ACOS through campaign optimization, keyword strategy and bid management.
          </p>
        </motion.header>
